    ...
    public class Contact : Entity
    {
        ...
        public static implicit operator ATWS.Contact(Contact contact)
        {
            return new ATWS.Contact()
            {
                ...
                AccountPhysicalLocationID = contact.AccountPhysicalLocationID,
                Active = contact.Active,
                AdditionalAddressInformation = contact.AdditionalAddressInformation,
                AddressLine = contact.AddressLine,
                AddressLine1 = contact.AddressLine1,
                AlternatePhone = contact.AlternatePhone,
                BulkEmailOptOut = contact.BulkEmailOptOut,
                BulkEmailOptOutTime = contact.BulkEmailOptOutTime,
                City = contact.City,
                ...
                SolicitationOptOut = contact.SolicitationOptOut,
                SolicitationOptOutTime = contact.SolicitationOptOutTime,
                State = contact.State,
                SurveyOptOut = contact.SurveyOptOut,
                Title = contact.Title,
