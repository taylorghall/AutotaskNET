...
namespace AutotaskNET.Entities
{
    ...
    public class InstalledProduct : Entity
    {
        ...
        public InstalledProduct(ATWS.InstalledProduct entity) : base(entity)
        {
        ...
        } //end InstalledProduct(ATWS.InstalledProduct entity)

        public static implicit operator ATWS.InstalledProduct(InstalledProduct entity)
        {
            var newEntity = new ATWS.InstalledProduct();
        ...
        } //end implicit operator ATWS.InstalledProduct(InstalledProduct installedproduct)
